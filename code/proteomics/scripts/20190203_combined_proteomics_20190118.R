...
venn.plot = venn.diagram(
  list("LB_Proteomic" = rownames(diffexp.pr.all.LB)[diffexp.pr.all.LB$adj.P.Val<0.05],
       "M9_Proteomic" = rownames(diffexp.pr.all.M9)[diffexp.pr.all.M9$adj.P.Val<0.05],
       "SH2_Proteomic" = rownames(diffexp.pr.all.SH2)[diffexp.pr.all.SH2$adj.P.Val<0.05],
       "SH5_Proteomic" = rownames(diffexp.pr.all.SH5)[diffexp.pr.all.SH5$adj.P.Val<0.05]),
  filename = NULL,
  col="transparent",
