...
DEG_M9_regulations_Down = DEG_M9_regulations[(DEG_M9_regulations$log2FoldChange)<0,]
DEG_M9_reg_freq_Down = table(DEG_M9_regulations_Down$regulator)
write.csv(DEG_M9_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_M9_reg_freq_Down.csv", row.names = F)
DEG_M9_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_M9_reg_freq_Down.csv", header = T)
colnames(DEG_M9_reg_freq_Down) = c("regulator", "frequency")
dim(DEG_M9_reg_freq_Down)
DEG_M9_reg_freq_Down = DEG_M9_reg_freq_Down[!DEG_M9_reg_freq_Down$regulator == "",]
dim(DEG_M9_reg_freq_Down)
DEG_M9_reg_freq_Down = DEG_M9_reg_freq_Down[(DEG_M9_reg_freq_Down$frequency)>0,]
write.csv(DEG_M9_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_M9_reg_freq_Down.csv", row.names = F)
View(DEG_M9_reg_freq_Down)

#SH2
DEG_SH2_regulations = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_SH2_regulations.csv", header = T)
DEG_SH2_regulations_Down = DEG_SH2_regulations[(DEG_SH2_regulations$log2FoldChange)<0,]
DEG_SH2_reg_freq_Down = table(DEG_SH2_regulations_Down$regulator)
write.csv(DEG_SH2_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH2_reg_freq_Down.csv", row.names = F)
DEG_SH2_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH2_reg_freq_Down.csv", header = T)
colnames(DEG_SH2_reg_freq_Down) = c("regulator", "frequency")
dim(DEG_SH2_reg_freq_Down)
DEG_SH2_reg_freq_Down = DEG_SH2_reg_freq_Down[!DEG_SH2_reg_freq_Down$regulator == "",]
dim(DEG_SH2_reg_freq_Down)
DEG_SH2_reg_freq_Down = DEG_SH2_reg_freq_Down[(DEG_SH2_reg_freq_Down$frequency)>0,]
write.csv(DEG_SH2_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH2_reg_freq_Down.csv", row.names = F)
View(DEG_SH2_reg_freq_Down)

#SH5
DEG_SH5_regulations = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_SH5_regulations.csv", header = T)
DEG_SH5_regulations_Down = DEG_SH5_regulations[(DEG_SH5_regulations$log2FoldChange)<0,]
DEG_SH5_reg_freq_Down = table(DEG_SH5_regulations_Down$regulator)
write.csv(DEG_SH5_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH5_reg_freq_Down.csv", row.names = F)
DEG_SH5_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH5_reg_freq_Down.csv", header = T)
colnames(DEG_SH5_reg_freq_Down) = c("regulator", "frequency")
dim(DEG_SH5_reg_freq_Down)
DEG_SH5_reg_freq_Down = DEG_SH5_reg_freq_Down[!DEG_SH5_reg_freq_Down$regulator == "",]
dim(DEG_SH5_reg_freq_Down)
DEG_SH5_reg_freq_Down = DEG_SH5_reg_freq_Down[(DEG_SH5_reg_freq_Down$frequency)>0,]
write.csv(DEG_SH5_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH5_reg_freq_Down.csv", row.names = F)
View(DEG_SH5_reg_freq_Down)
...
DEG_SH5_vs_SH2_regulations_Down = DEG_SH5_vs_SH2_regulations[(DEG_SH5_vs_SH2_regulations$log2FoldChange)<0,]
DEG_SH5_vs_SH2_reg_freq_Down = table(DEG_SH5_vs_SH2_regulations_Down$regulator)
write.csv(DEG_SH5_vs_SH2_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH5_vs_SH2_reg_freq_Down.csv", row.names = F)
DEG_SH5_vs_SH2_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulations/csv/DEG_regulation_freq_Down/DEG_SH5_vs_SH2_reg_freq_Down.csv", header = T)
colnames(DEG_SH5_vs_SH2_reg_freq_Down) = c("regulator", "frequency")
dim(DEG_SH5_vs_SH2_reg_freq_Down)
DEG_SH5_vs_SH2_reg_freq_Down = DEG_SH5_vs_SH2_reg_freq_Down[!DEG_SH5_vs_SH2_reg_freq_Down$regulator == "",]
dim(DEG_SH5_vs_SH2_reg_freq_Down)
DEG_SH5_vs_SH2_reg_freq_Down = DEG_SH5_vs_SH2_reg_freq_Down[(DEG_SH5_vs_SH2_reg_freq_Down$frequency)>0,]
write.csv(DEG_SH5_vs_SH2_reg_freq_Down, "./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH5_vs_SH2_reg_freq_Down.csv", row.names = F)
View(DEG_SH5_vs_SH2_reg_freq_Down)


#frequency tables
DEG_M9_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_M9_reg_freq_Down.csv", header = T)
DEG_SH2_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH2_reg_freq_Down.csv", header = T)
DEG_SH5_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH5_reg_freq_Down.csv", header = T)
DEG_SH5_vs_SH2_reg_freq_Down = read.csv("./diff.exp.gene/DEG_SM/geneRegulations/regulators/csv/DEG_reg_freq_Down/DEG_SH5_vs_SH2_reg_freq_Down.csv", header = T)
...
#M9
DEG_M9_reg_freq_Down_mod = DEG_M9_reg_freq_Down[(DEG_M9_reg_freq_Down$frequency)>2,]
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/barplot/DEG_Down_barplot/barplot_DEG_M9_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
DEG_M9_reg_freq_Down_mod = ggplot(DEG_M9_reg_freq_Down_mod, aes(x="", y=frequency, fill=regulator))+
  geom_bar(width = 2, stat = "identity") + ggtitle("DEG M9 reg Down") + 
...
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/pie/DEG_Down_pie/pie_DEG_M9_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
pie_M9 = DEG_M9_reg_freq_Down_mod + coord_polar("y", start=0)
pie_M9
coord_fixed()
dev.off() 
...
#SH2
DEG_SH2_reg_freq_Down_mod = DEG_SH2_reg_freq_Down[(DEG_SH2_reg_freq_Down$frequency)>2,]
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/barplot/DEG_Down_barplot/barplot_DEG_SH2_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
DEG_SH2_reg_freq_Down_mod = ggplot(DEG_SH2_reg_freq_Down_mod, aes(x="", y=frequency, fill=regulator))+
  geom_bar(width = 2, stat = "identity") + ggtitle("DEG SH2 reg Down") + 
...
#                                                                    label = percent(frequency/100)), size=5)
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/pie/DEG_Down_pie/pie_DEG_SH2_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
pie_SH2 = DEG_SH2_reg_freq_Down_mod + coord_polar("y", start=0)
pie_SH2
coord_fixed()
dev.off() 
...
#SH5
DEG_SH5_reg_freq_Down_mod = DEG_SH5_reg_freq_Down[(DEG_SH5_reg_freq_Down$frequency)>2,]
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/barplot/DEG_Down_barplot/barplot_DEG_SH5_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
DEG_SH5_reg_freq_Down_mod = ggplot(DEG_SH5_reg_freq_Down_mod, aes(x="", y=frequency, fill=regulator))+
  geom_bar(width = 2, stat = "identity") + ggtitle("DEG SH5 reg Down") + 
...
#                                                                    label = percent(frequency/100)), size=5)
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/pie/DEG_Down_pie/pie_DEG_SH5_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
pie_SH5 = DEG_SH5_reg_freq_Down_mod + coord_polar("y", start=0)
pie_SH5
coord_fixed()
dev.off() 
...
#SH5_vs_SH2
DEG_SH5_vs_SH2_reg_freq_Down_mod = DEG_SH5_vs_SH2_reg_freq_Down[(DEG_SH5_vs_SH2_reg_freq_Down$frequency)>18,]
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/barplot/DEG_Down_barplot/barplot_DEG_SH5_vs_SH2_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
DEG_SH5_vs_SH2_reg_freq_Down_mod = ggplot(DEG_SH5_vs_SH2_reg_freq_Down_mod, aes(x="", y=frequency, fill=regulator))+
  geom_bar(width = 2, stat = "identity") + ggtitle("DEG SH5_vs_SH2 reg Down") + 
...
DEG_SH5_vs_SH2_reg_freq_Down_mod
coord_fixed()
dev.off()  
#Create a pie chart 
...
#                                                                    label = percent(frequency/100)), size=5)
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/pie/DEG_Down_pie/pie_DEG_SH5_vs_SH2_reg_Down.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
pie_SH5_vs_SH2 = DEG_SH5_vs_SH2_reg_freq_Down_mod + coord_polar("y", start=0)
pie_SH5_vs_SH2
coord_fixed()
dev.off()  
...
#barplot_all
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/barplot/DEG_Down_barplot/barplot_DEG_SH5_reg_freq_Down_mod_all.pdf" ,width=5, height=5)      #turn this OFF if just want to see the picture in the Plots
barplot_DEG_SH5_reg_freq_Down_mod_all = grid.arrange(DEG_M9_reg_freq_Down_mod, DEG_SH2_reg_freq_Down_mod,
                           DEG_SH5_reg_freq_Down_mod, DEG_SH5_vs_SH2_reg_freq_Down_mod, nrow = 6)
barplot_DEG_SH5_reg_freq_Down_mod_all
coord_fixed()
dev.off() 

#pie_all
pdf("./diff.exp.gene/DEG_SM/Figures/geneRegulations/regulators/pie/DEG_Down_pie/pie_DEG_SH5_reg_freq_Down_mod_all.pdf" ,width=10, height=10)      #turn this OFF if just want to see the picture in the Plots
pie_DEG_SH5_reg_freq_Down_mod_all = grid.arrange(pie_M9, pie_SH2,
