...
setwd("~/OneDrive - University of Warwick/WORK/RESULTS/TRANSCRIPTOMICS/intersection_toRNAdo_all/filt_txt_all_2")
...
#Reading SampleTable
sampleTable = read.csv("./sampleTable_ED.csv", header = T)
sampleTable_ED_M9 = sampleTable[10:18,]
sampleTable_ED_LB = sampleTable[1:9,]


#Reading Combined Read Counts 
counts.all = read.csv("./counts.all_ED_ S1583.csv", header = T) #change it 
